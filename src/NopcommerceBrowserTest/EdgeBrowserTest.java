...
public class EdgeBrowserTest {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("webdriver.edge.driver", "drivers/msedgedriver.exe");// driver key and driverpath
        WebDriver driver = new EdgeDriver();// driver object in firefox driver class to operate different functionality of webpage
        ...
        boolean verifytitle = title.equals("nop Commerce demo store");// verify title in equals functionality  with boolean type
